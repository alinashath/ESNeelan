...
/**
 * Official MMA Rufiyaa currency symbol as SVG.
 * Always place to the left of the amount (MMA Currency Symbol Guideline).
 */
export function RufiyaaSign({
  size = 16,
  color = "currentColor",
  accessibilityLabel = "Rufiyaa",
}: Props) {
  const height = size;
  const width = Math.round((VB_W / VB_H) * height * 10) / 10;
  ...
  return (
    ...
    >
      <Path d={RUFIYAA_PATH} fill={color} />
    </Svg>
  );
}
